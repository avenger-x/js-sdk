...
var POSRootChainManager = /** @class */ (function (_super) {
    ...
    function POSRootChainManager(options, rootChain, web3Client) {
        ...
        var abi = options.network.abi('RootChainManager', 'pos');
        if (abi && abi.length > 1 && abi[abi.length - 1].name === 'receive') {
            delete abi[abi.length - 1].name;
        }
        _this.posRootChainManager = new _this.web3Client.parentWeb3.eth.Contract(abi, options.posRootChainManager || options.network.Main.POSContracts.RootChainManagerProxy);
    ...
    POSRootChainManager.prototype.exitTron = function (burnTxHash, logSignature, options, tronOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.exitManager.buildPayloadForExitTron(burnTxHash, logSignature, this.requestConcurrency, tronOptions)];
                    case 1:
                        payload = _a.sent();
    ...
    POSRootChainManager.prototype.exitTronERC20 = function (burnTxHash, options, tronOptions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.exitTron(burnTxHash, ERC20_TRANSFER_EVENT_SIG, options, tronOptions)];
            });
        });
    };
