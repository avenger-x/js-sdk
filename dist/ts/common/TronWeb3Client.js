...
var TronWeb3Client = /** @class */ (function () {
    function TronWeb3Client(parentProvider, maticProvider, parentDefaultOptions, maticDefaultOptions, tronWebOptions) {
    ...
    Object.defineProperty(TronWeb3Client.prototype, "wallet", {
    ...
    TronWeb3Client.prototype.call = function (method, options) {
    ...
    TronWeb3Client.prototype.fillOptions = function (txObject, onRootChain, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (onRootChain) {
                    return [2 /*return*/, this._fillOptions(txObject, this.parentWeb3, options || this.parentDefaultOptions, onRootChain)];
                }
                return [2 /*return*/, this._fillOptions(txObject, this.web3, options || this.maticDefaultOptions, onRootChain)];
            });
        });
    };
    TronWeb3Client.prototype._fillOptions = function (txObject, web3, _options, onRootChain) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TronWeb3Client.prototype.wrapWeb3Promise = function (promise, callbacks) {
        if (callbacks) {
            if (promise.on) {
    ...
    TronWeb3Client.prototype.send = function (txObject, web3Options, callbacks) {
    ...
    TronWeb3Client.prototype.getParentWeb3 = function () {
        return this.parentWeb3;
    };
    TronWeb3Client.prototype.getMaticWeb3 = function () {
        return this.web3;
    };
    TronWeb3Client.prototype.getWallet = function () {
        return this.web3.eth.accounts.wallet;
    };
    TronWeb3Client.prototype.setParentDefaultOptions = function (options) {
        this.parentDefaultOptions = options;
    };
    TronWeb3Client.prototype.setMaticDefaultOptions = function (options) {
        this.maticDefaultOptions = options;
    };
    TronWeb3Client.prototype.setParentProvider = function () {
        this.parentWeb3 = this.utils.createTronWeb(this.tronWebOptions);
    };
    return TronWeb3Client;
}());
exports.default = TronWeb3Client;
