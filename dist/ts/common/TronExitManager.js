...
var TronContractsBase_1 = __importDefault(require("./TronContractsBase"));
...
var TronExitManager = /** @class */ (function (_super) {
    __extends(TronExitManager, _super);
    function TronExitManager(rootChain, options, web3Client) {
    ...
    TronExitManager.prototype.buildPayloadForExit = function (burnTxHash, logEventSig, requestConcurrency) {
        return __awaiter(this, void 0, void 0, function () {
            var lastChildBlock, burnTx, receipt, block, lastChildBlockNumber, burnTxBlockNumber, headerBlockNumber, contract, headerBlock, blockProof, receiptProof, logIndex, withdrawLogSign, payload;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        lastChildBlockNumber = new bn_js_1.default(lastChildBlock.toNumber());
                        burnTxBlockNumber = new bn_js_1.default(burnTx.blockNumber);
                        assert_1.default.ok(lastChildBlockNumber.gte(burnTxBlockNumber), 'Burn transaction has not been checkpointed as yet');
                        return [4 /*yield*/, this.rootChain.findHeaderBlockNumber(burnTx.blockNumber)];
                    case 5:
                        headerBlockNumber = _a.sent();
                        return [4 /*yield*/, this.rootChain.rootChain.tronWeb.contract(this.rootChain.rootChain.abi, this.rootChain.rootChain.token)];
                    case 6:
                        contract = _a.sent();
                        return [4 /*yield*/, this.web3Client.call(contract.methods.headerBlocks(this.encode(headerBlockNumber)))];
                    case 7:
                        headerBlock = _a.sent();
                    ...
                    case 9:
                        ...
                        logIndex = -1;
                        withdrawLogSign = '0x67b714876402c93362735688659e2283b4a37fb21bab24bc759ca759ae851fd8' // WithdrawTo(address,address,uint256)
                        ;
                        logIndex = receipt.logs.findIndex(function (log) { return log.topics[0].toLowerCase() == withdrawLogSign.toLowerCase(); });
                        assert_1.default.ok(logIndex > -1, 'Log not found in receipt');
                        payload = this._encodePayload(headerBlockNumber, blockProof, burnTx.blockNumber, block.timestamp, Buffer.from(block.transactionsRoot.slice(2), 'hex'), Buffer.from(block.receiptsRoot.slice(2), 'hex'), ProofsUtil_1.default.getReceiptBytes(receipt), // rlp encoded
    ...
    TronExitManager.prototype.buildPayloadForExitFastMerkle = function (start, end, blockNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var blockProof;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TronExitManager.prototype.buildPayloadForExitHermoine = function (burnTxHash, logEventSig) {
        return __awaiter(this, void 0, void 0, function () {
            var lastChildBlock, receipt, lastChildBlockNumber, receiptBlockNumber, block, headerBlock, blockIncludedResponse, err_1, headerBlockNumber, contract, start, end, number, blockProof, blockProofResponse, err_2, receiptProof, logIndex;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rootChain.getLastChildBlock()];
                    case 1:
                    ...
                    case 2:
                        receipt = _a.sent();
                        lastChildBlockNumber = new bn_js_1.default(lastChildBlock.toNumber());
                        receiptBlockNumber = new bn_js_1.default(receipt.blockNumber);
                        return [4 /*yield*/, this.web3Client
                                .getMaticWeb3()
                    ...
                    case 3:
                        ...
                        assert_1.default.ok(lastChildBlockNumber.gte(receiptBlockNumber), 'Burn transaction has not been checkpointed as yet');
                        _a.label = 4;
                    case 4:
                        _a.trys.push([4, 6, , 10]);
                    ...
                    case 14:
                        blockProof = _a.sent();
                        return [3 /*break*/, 15];
                    case 15: return [4 /*yield*/, ProofsUtil_1.default.getReceiptProof(receipt, block, this.web3Client.getMaticWeb3())];
                    case 16:
                        receiptProof = _a.sent();
                        logIndex = -1;
                        switch (logEventSig) {
    ...
    TronExitManager.prototype.getExitHash = function (burnTxHash, logEventSig, requestConcurrency) {
        return __awaiter(this, void 0, void 0, function () {
            var lastChildBlock, receipt, block, lastChildBlockNumber, receiptBlockNumber, receiptProof, logIndex, nibbleArr;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rootChain.getLastChildBlock()];
                    case 1:
    ...
    TronExitManager.prototype._encodePayload = function (headerNumber, buildBlockProof, blockNumber, timestamp, transactionsRoot, receiptsRoot, receipt, receiptParentNodes, path, logIndex) {
    ...
    return TronExitManager;
}(TronContractsBase_1.default));
exports.default = TronExitManager;
